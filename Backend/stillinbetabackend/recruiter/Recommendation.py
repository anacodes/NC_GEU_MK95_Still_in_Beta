...
def Recommendation(Resume, JobDesc):
    ...
    startIndex = len(
        Resume)  # This the index from where JD's begin in the combined list
    ...
    for i in range(len(Resume)):
        ...
        max_score = 0.2  #Threshold being set to 0.1
        curr_choice = -1
        ...
        choice.append(
            curr_choice
        )  # if curr_choice == -1, no relevant jobs were found for the user
