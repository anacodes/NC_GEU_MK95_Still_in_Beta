...
import VacancyExtract
import DateExtract
import SalaryExtract
...
with open(file_path, 'rb') as file:
    ...
    if(file_type=="pdf"):
        ...
        text = convert_pdf_to_txt(file_path, pages=range(0,number_of_pages))
    elif(file_type=="docx"):
    ...
    found_locations = []
    database = pd.read_csv("pincode(reduced).csv", sep=',', engine='python')
